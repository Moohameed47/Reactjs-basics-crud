...
export const productValidation = (productObj: { title: string; description: string; imageURL: string; price: string; color: string[] }) => {
  // RETURNS AN OBJECT

  const errors: { title: string; description: string; imageURL: string; price: string; color: string } = {
    title: "",
    description: "",
    imageURL: "",
    price: "",
  ...
  if (productObj.color == undefined || productObj.color?.length == 0) errors.color = "You should choose color first!";
